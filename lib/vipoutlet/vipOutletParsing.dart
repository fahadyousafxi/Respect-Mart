...
//
    ...
    //For title
        print('Title Tag is ${document.getElementsByClassName("product-entry__title")}');
        var titleTag = document.getElementsByClassName("product-entry__title");

        print('Title is : $titleTag');

        this.title = titleTag[0].innerHtml.replaceAll(" USD", "");
        print('T Title is  : ${this.title}');
        //For price
//
       var pr = document.getElementsByClassName("woocommerce-Price-amount amount");
