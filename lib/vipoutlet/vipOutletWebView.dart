...
class VipOutletWebView extends StatefulWidget {
  String url = "";
  bool check = false;

  VipOutletWebView(this.url);

  @override
  VipOutletWebViewState createState() {
    try {
      return new VipOutletWebViewState(this.url);
    } catch (Exception) {
      print(Exception);
    }
  }
...
class VipOutletWebViewState extends State<VipOutletWebView> {
  ...
  VipOutletWebViewState(this.url);
  ...
  void initState() {
    ...
    if (this.url.contains("/product/")) {
      ...
      MyApp.objVipOutletPrsing.reset();
                ...
                _controller.future.then((test) {
                  test.currentUrl().then((value) {
                    ...
                    if (temporyurl.contains("/product/") ) {
                      ...
                      MyApp.objVipOutletPrsing
                          .viewProduct(temporyurl)
                          .then((success) {
                        if (MyApp.objVipOutletPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objVipOutletPrsing.addTofav(temporyurl);
                          String desc = "";
                          String title = "";
                    ...
                    if (check) {
                      ...
                      MyApp.objVipOutletPrsing
                        ...
                        if (MyApp.objVipOutletPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objVipOutletPrsing.addTocart(temporyurl);
                          String desc = "";
                          String title = "";
                          AlertType alertType = AlertType.success;
