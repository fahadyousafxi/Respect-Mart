...
class MacysWebView extends StatefulWidget {
  String url = "";
  bool check = false;

  MacysWebView(this.url);

  @override
  MacysWebViewState createState() {
    try {
      return new MacysWebViewState(this.url);
    } catch (Exception) {
      print(Exception);
    }
  }
...
class MacysWebViewState extends State<MacysWebView> {
  ...
  void initState() {
    ...
    if (this.url.contains("/shop/product/")) {
      _showAddToCartButton(true);
      temporyurl = url;
      MyApp.url = url;
    } else {
      MyApp.objMacysPrsing.reset();
              ...
              onTap: () {
                ...
                _controller.future.then((test) {
                  test.currentUrl().then((value) {
                    ...
                    print("\n\n\n\n\n");
                    temporyurl = value;
                    if (temporyurl.contains("/shop/product/") ) {
                      MyApp.showProgressDialog(context, "Adding to favourite");

                      MyApp.objMacysPrsing
                          .viewProduct(temporyurl)
                          .then((success) {
                        if (MyApp.objMacysPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objMacysPrsing.addTofav(temporyurl);
                          String desc = "";
                          String title = "";
                    ...
                    if (check) {
                      ...
                      MyApp.objMacysPrsing
                        ...
                        if (MyApp.objMacysPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objMacysPrsing.addTocart(temporyurl);
                          String desc = "";
                          String title = "";
                          AlertType alertType = AlertType.success;
