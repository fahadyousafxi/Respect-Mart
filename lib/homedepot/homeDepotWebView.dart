...
class HomeDepotWebView extends StatefulWidget {
  String url = "";
  bool check = false;

  HomeDepotWebView(this.url);

  @override
  HomeDepotWebViewState createState() {
    try {
      return new HomeDepotWebViewState(this.url);
    } catch (Exception) {
      print(Exception);
    }
  }
...
class HomeDepotWebViewState extends State<HomeDepotWebView> {
  ...
  HomeDepotWebViewState(this.url);
  ...
  void initState() {
    ...
    if (this.url.contains("/p/")) {
      ...
      MyApp.objHomeDepotPrsing.reset();
                ...
                _controller.future.then((test) {
                  test.currentUrl().then((value) {
                    ...
                    if (temporyurl.contains("/p/") ) {
                      ...
                      MyApp.objHomeDepotPrsing
                          .viewProduct(temporyurl)
                          .then((success) {
                        if (MyApp.objHomeDepotPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objHomeDepotPrsing.addTofav(temporyurl);
                          String desc = "";
                          String title = "";
                    ...
                    if (check) {
                      ...
                      MyApp.objHomeDepotPrsing
                        ...
                        if (MyApp.objHomeDepotPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objHomeDepotPrsing.addTocart(temporyurl);
                          String desc = "";
                          String title = "";
                          AlertType alertType = AlertType.success;
