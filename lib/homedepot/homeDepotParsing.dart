...
//
//
       var im = document.getElementsByClassName("MagicZoom");

       //print('Image is: ${im[1].attributes['src']}');
       if(im.length>0) {
         image = im[0].attributes['href'];
         print('Srcs is: $image');

       }
    //For title
        print('Title Tag is ${document.getElementsByClassName("product-title__title")}');
        var titleTag = document.getElementsByClassName("product-title__title");
        ...
        //For price
//
       var pr = document.getElementsByClassName("price__dollars");

       if(pr.length>0){

         price = pr[0].text.trim();
         print(price);

       }


      var cl = document.getElementsByClassName("attribute__name");
