...
class SplashScreenState extends State<SplashScren> {
  ...
  Widget build(BuildContext context) {
    ...
    return new SplashScreen(
      seconds: 5,
      navigateAfterSeconds: GridLayout(),
      title: new Text(
        'Welcome to RespectMart',
        style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0),
      ),
      image: Image.asset('assets/images/makaya_round.png'),
      backgroundColor: Colors.white,
      styleTextUnderTheLoader: new TextStyle(),
      photoSize: 100.0,
      onClick: () => print("Makaya"),
      loaderColor: MyApp.primarycolor,
      loadingText: new Text("Powered By: Afridext Integrated Services LLC"),
    );
  }
