...
import 'package:makaya/OrderLink.dart';
...
class ViewCart extends State<ViewCartItems> {
  ...
  double calculateTotal() {
    ...
    for (int i = 0; i < MyApp.aitems.length; i++) {
      ...
      print(str);
      str=str.replaceAll("\$","").substring(0, str.indexOf('.'))+"0";
      print("hello"+str.substring(1).replaceAll(",", ""));
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
            padding: EdgeInsets.only(top: 30.0),
            child: Text(
              "Price:" + MyApp.aitems[i].price.toString().replaceAll("\$", "USD:"),
              style: TextStyle(
                  color: Colors.black,
                  fontSize: 30.0,
                  fontWeight: FontWeight.normal),
                    ...
                    buttons: [
                      DialogButton(
                        ...
                        onPressed: () {
                          Navigator.pop(context);
                          Navigator.pop(context);
                          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>OrderLink(url: "${value.toString()}")));
                        },
                        width: 60,
                      )
                    ],
