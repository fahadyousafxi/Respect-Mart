...
//
//
       var im = document.getElementsByClassName("product-detail-main-image-container");

       //print('Image is: ${im[1].attributes['src']}');
       if(im.length>0) {
         image = im[0].getElementsByTagName("img")[0].attributes['src'];
         print(image);
         print('Srcs is: $image');

       }
    //For title
        print('Title Tag is ${document.getElementsByClassName("primary product-item-headline")}');
        var titleTag = document.getElementsByClassName("primary product-item-headline");
        ...
        //For price
//
       var pr = document.getElementsByClassName("price-value");

       if(pr.length>0){

         price = pr[0].text.split(" ").last;
         print(price);

       }
      var cl = document.getElementsByClassName("product-input-label");
