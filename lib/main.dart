...
import 'RespectMart/RespectMartParsing.dart';
Future<void> main() async {
  WidgetsFlutterBinding.ensureInitialized();
  await Firebase.initializeApp();
  MyApp();
  bool check = await MyApp.checkInternet();
  MyApp.login=await MyApp.checkLogin();
  if(check) {
    runApp(
          MaterialApp(
...
static Future<bool> checkLogin()async{
    ...
    logined=pref.getBool("login");
    if(logined!=null || logined==true){
      return true;
    }
    return false;
  }
 // static String base_url = "https://ahmedplastics.com/learning/public/api";
  static String base_url = "https://app.respectmart.com/api";
 ...
 static RespectDataParsing objRespectPrsing = new RespectDataParsing();

 static FashionNovaDataParsing objFashionNovaPrsing =
      new FashionNovaDataParsing();
  static Color primarycolor = Color.fromRGBO(140, 198, 63, 1.0);
