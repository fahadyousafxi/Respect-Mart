...
class LowesWebView extends StatefulWidget {


  String url = "";
  bool check = false;

  LowesWebView(this.url);

  @override
  LowesWebViewState createState() {
    try {
      return new LowesWebViewState(this.url);
    } catch (Exception) {
      print(Exception);
    }
  }
...
class LowesWebViewState extends State<LowesWebView> {
                          ...
                          Alert(
                            ...
                            buttons: [
                              DialogButton(
                                ...
                                width: 60,
                                color: check==0?Colors.redAccent:check==1?Colors.green:Colors.blueAccent,
                              )
                            ],
                          ).show();
