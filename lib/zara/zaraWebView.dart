...
class ZaraWebView extends StatefulWidget {
  String url = "";
  bool check = false;

  ZaraWebView(this.url);

  @override
  ZaraWebViewState createState() {
    try {
      return new ZaraWebViewState(this.url);
    } catch (Exception) {
      print(Exception);
    }
  }
...
class ZaraWebViewState extends State<ZaraWebView> {
                  ...
                  test.currentUrl().then((value) {
                    ...
                    if (temporyurl.contains("/product/") ) {
                      ...
                      MyApp.objZaraPrsing
                          ...
                          .then((success) {
                        if (MyApp.objZaraPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objZaraPrsing.addTofav(temporyurl);
                          String desc = "";
                          String title = "";
                    ...
                    if (check) {
                      ...
                      MyApp.objZaraPrsing
                        ...
                        if (MyApp.objZaraPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objZaraPrsing.addTocart(temporyurl);
                          String desc = "";
                          String title = "";
                          AlertType alertType = AlertType.success;
