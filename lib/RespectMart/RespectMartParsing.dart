...
//
      ...
      print('Title Tag is ${document.getElementsByClassName("fs-21 opacity-80 mb-3 lh-1-3")}');
      var titleTag = document.getElementsByClassName("fs-21 opacity-80 mb-3 lh-1-3");
      ...
      //For price
//
      var pr = document.getElementsByClassName("primary--text fs-24 fw-500");
