...
class RespectMartView extends StatefulWidget {
  String url = "";
  bool check = false;

  RespectMartView(this.url);

  @override
  RespectMartViewState createState() {
    try {
      return new RespectMartViewState(this.url);
    } catch (Exception) {
      print(Exception);
    }
  }
...
class RespectMartViewState extends State<RespectMartView> {
                  ...
                  onTap: () {
                    ...
                    _controller.future.then((test) {
                      test.currentUrl().then((value) {
                        ...
                        temporyurl = value;
                        print(temporyurl);
                        if (temporyurl.contains("product") ) {
                          MyApp.showProgressDialog(context, "Adding to favourite");

                          MyApp.objRespectPrsing
                              .viewProduct(temporyurl)
                              .then((success) {
                            if (MyApp.objRespectPrsing.parsedSuccess && success) {
                              print("Done Scrapping");
                              int check =
                              MyApp.objRespectPrsing.addTofav(temporyurl);
                              String desc = "";
                              String title = "";
                    ...
                    if (check) {
                      ...
                      MyApp.objRespectPrsing
                        ...
                        if (MyApp.objRespectPrsing.parsedSuccess && success) {
                          print("Done Scrapping");
                          int check =
                          MyApp.objRespectPrsing.addTocart(temporyurl);
                          String desc = "";
                          String title = "";
                          AlertType alertType = AlertType.success;
