...
class Forever21WebView extends StatefulWidget {

  Forever21WebView(this.url);
  bool check = false;
  String url = "";


  @override
  Forever21WebViewState createState() {
    try {
      return new Forever21WebViewState(this.url);
    } catch (Exception) {
      print(Exception);
    }
  }
...
class Forever21WebViewState extends State<Forever21WebView> {

  Forever21WebViewState(this.url);

  Completer<WebViewController> _controller = Completer<WebViewController>();
  ScrollController _scrollController;
  bool navVisibility = false;
  bool appIndicator = false;
  bool _visible = true;
  ...
  void initState() {
    ...
    if (this.url.contains("/us/200")) {
      _showAddToCartButton(true);
      temporaryUrl = url;
      MyApp.url = url;
    } else {
      MyApp.objForever21Prsing.reset();
              ...
              onTap: () {
                ...
                _controller.future.then((test) {
                  test.currentUrl().then((value) {
                    ...
                    print("\n\n\n\n\n");
                    temporaryUrl = value;
                    if (temporaryUrl.contains("/us/200")) {
                      MyApp.showProgressDialog(context, "Adding to favourite");

                      MyApp.objForever21Prsing
                          .viewProduct(temporaryUrl)
                          .then((success) {
                        if (MyApp.objForever21Prsing.parsedSuccess &&
                            success) {
                          print("Done Scrapping");
                          int check =
                              MyApp.objForever21Prsing.addToFav(temporaryUrl);
                          String desc = "";
                          String title = "";
                    ...
                    if (check) {
                      ...
                      MyApp.objForever21Prsing
                        ...
                        if (MyApp.objForever21Prsing.parsedSuccess &&
                          ...
                          print("Done Scrapping");
                          int check =
                              MyApp.objForever21Prsing.addToCart(temporaryUrl);
                          String desc = "";
                          String title = "";
                          AlertType alertType = AlertType.success;
